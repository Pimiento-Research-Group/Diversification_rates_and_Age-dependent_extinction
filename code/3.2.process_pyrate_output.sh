...
4. Generate file containing the preservation rate through time
'
#1.
...
#4
python3 ./PyRate-master/PyRate.py -plotQ /path_to_output_folder/combined_10_mcmc.log -qShift /path_to_input_files/stages.txt -b 0.1
